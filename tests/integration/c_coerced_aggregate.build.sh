...
"${CC:-clang}" -c c_coerced_aggregate.c -o "$lib_dir/callees.o"
ar rcs "$lib_dir/libcoercedcallees.a" "$lib_dir/callees.o"

"$1" c_coerced_aggregate.pas -o "$2" -L"$lib_dir" -lcoercedcallees
