...
CODEGEN_SRCS := src/cg_base.pas src/cg_base.inc src/cg_util.pas src/cg_util.inc src/cg_types.pas src/cg_types.inc src/cg_symbols.pas src/cg_symbols.inc src/cg_expr.pas src/cg_expr.inc $(wildcard src/codegen_*.inc)
